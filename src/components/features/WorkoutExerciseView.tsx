          ...
          <Table className="w-full min-w-[340px]">{/* Use min-width instead of w-auto to ensure minimum space */}
            ...
            <TableHeader>
              ...
              <TableRow className="text-xs">
                <TableHead className="w-[35px] text-center px-1 py-1">Set</TableHead><TableHead className="w-[80px] text-center px-1 py-1">Prev.</TableHead>{/* Abbreviated */}<TableHead className="w-[75px] text-center px-1 py-1">Wt (kg)</TableHead>{/* Abbreviated */}<TableHead className="w-[60px] text-center px-1 py-1">Reps</TableHead>{/* Adjusted check column size and padding */}<TableHead className="w-[40px] p-0 text-center"><Check size={16} className="mx-auto" /></TableHead>
              </TableRow>
