...
const PresencePeek = () => {
  ...
  return (
    <div className="pointer-events-none fixed bottom-[calc(5rem+env(safe-area-inset-bottom,0px))] left-4 right-[5.5rem] z-40 flex h-14 items-center justify-end md:bottom-6">
